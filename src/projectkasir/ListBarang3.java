 ...
 */
public class ListBarang3 extends javax.swing.JFrame {
    ...
    private void load_table() {
        ...
        try {
            String query = ("SELECT id_barang, nama_barang, stok FROM daftar_barang WHERE id_barang LIKE '%" + cari + "%' OR nama_barang LIKE '%" + cari + "%'"
                    + "OR stok LIKE '%" + cari + "%'");
    ...
    private void btnpilihActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnpilihActionPerformed
        ...
        String stok = tblbarang.getValueAt(i, 2).toString();
        
        pn_lapopname.txtkdbarang.setText(kodeBarang);
        pn_lapopname.txtnamabarang.setText(namaBarang);
        pn_lapopname.txtstoksistem.setText(stok);
        
        dispose();
        pn_lapopname.txtnamabarang.disable();
        pn_lapopname.txtstoksistem.disable();
        pn_lapopname.txtstokfisik.requestFocus();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ListBarang3.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
