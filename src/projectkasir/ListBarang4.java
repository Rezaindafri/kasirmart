 ...
 */
public class ListBarang4 extends javax.swing.JFrame {
    ...
    private void btnpilihActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnpilihActionPerformed
        ...
        pn_lapstok.txtkdbarang.setText(kodeBarang);
        pn_lapstok.txtnamabarang.setText(namaBarang);
        pn_lapstok.txtstokawal.setText(stok);
        
        dispose();
        pn_lapstok.txtnamabarang.disable();
        pn_lapstok.txtstokawal.disable();
        pn_lapstok.txtexpiredawal.requestFocus();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ListBarang4.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
